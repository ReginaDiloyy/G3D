...
namespace G3Dsys_database
{
    public partial class ItemDetails : Form
    {
        ...
        private void EditBtn_Click(object sender, EventArgs e)
        {
            ...
            editform.EditInvoiceTBox.Text = add.Invoice; //dont remove
        ...
        {
            FirebaseResponse dwgDL = client.Get("ItemList/Items/Files/" + InvoiceTBox.Text);
            Files add = dwgDL.ResultAs<Files>();
            Process.Start(add.dwgURL);
        }
    }
}

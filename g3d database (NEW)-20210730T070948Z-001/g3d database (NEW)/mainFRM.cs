    ...
    public partial class mainFRM : Form
    {
        ...
        public void DGrid()
        {
            ...
            try
            {
                ...
                dataGridView1.Columns[4].Visible = false; //Name of Item
                dataGridView1.Columns[5].Visible = false; //Price
                dataGridView1.Columns[6].Visible = false; //Stock
                dataGridView1.Columns[7].Visible = false; //Remarks
                dataGridView1.Columns[8].Width = 548; //Invoice
            }
